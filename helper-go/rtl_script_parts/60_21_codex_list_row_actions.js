  ...
  const removeCodexConversationListRowRenameControl = (row) => {
    ...
    row.querySelectorAll("." + CODEX_CHAT_LIST_PATH_BUTTON_CLASS_NAME).forEach((button) => button.remove());
    row.querySelectorAll("." + CODEX_CHAT_LIST_DOCTOR_BUTTON_CLASS_NAME).forEach((button) => button.remove());
